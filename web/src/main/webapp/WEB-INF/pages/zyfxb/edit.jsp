...
<div class="page-container">
    <form id="form-member-add">
        <div class="row cl" style="border-bottom: 1px solid #ddd;padding-bottom: 10px;margin-bottom: 10px;">
            <label class="col-xs-3 col-sm-3 f-16 text-r">学号：</label>
            <div class="formControls col-xs-9 col-sm-9">
                <input type="text" placeholder="请填写学号" name="xh" id="xh" value="" class="input-text radius size-M">
            </div>
        </div>
        <div class="row cl mt-20" style="border-bottom: 1px solid #ddd;padding-bottom: 10px;margin-bottom: 10px;">
            ...
            <div class="formControls col-xs-9 col-sm-9">
                <input type="text" placeholder="请填写联系电话" name="lxdh" id="lxdh" value="" class="input-text radius size-M">
            </div>
        </div>
...
<script type="text/javascript">
    ...
    $('#submit').click(function () {
        ...
        zyfxbForm.xh = xh;
        zyfxbForm.lxdh = lxdh;
        zyfxbForm.zyfxxxbId = $('input[name="ids"]').val();

        console.log("zyfxbForm",zyfxbForm);
