...
pathAnim = {
	...
	init: function (elem, fromD, toD) {
		...
		// pull out the dao lines before padding
		if (elem.isArea) {
		...
		if (startBaseLine) { // append the dao lines for areas
	...
	label: function (str, x, y, shape, anchorX, anchorY, useHTML, baseline, className) {
		...
		return extend(wrapper, {
			...
			destroy: function () {
				...
				// Call dao implementation to destroy the rest
...
/**
 * The Point object and prototype. Inheritable and used as dao for PiePoint
 */
var Point = function () {};
Point.prototype = {
...
/**
 * @classDescription The dao function which all other series types inherit from. The data in the series is stored
 * in various arrays.
 *
...
var AreaSeries = extendClass(Series, {
	...
	/**
	 * Extend the dao Series getSegmentPath method by adding the path for the area.
	 * This path is pushed to the series.areaPath property.
	 */
	getSegmentPath: function (segment) {
		
		var segmentPath = Series.prototype.getSegmentPath.call(this, segment), // call dao method
	...
	/**
	 * Draw the graph and the underlying area. This method calls the Series dao
...
defaultPlotOptions.column = merge(defaultSeriesOptions, {
	...
	groupPadding: 0.2,
	//grouping: true,
	marker: null, // point options are specified in the dao options
	pointPadding: 0.1,
	//pointWidth: null,
	minPointLength: 0,
...
var PieSeries = {
	...
	/**
	 * Override the dao drawDataLabels method by pie specific functionality
	 */
	drawDataLabels: function () {
		var series = this,
			data = series.data,
		...
		each(data, function (point) {
			if (point.dataLabel) { // it may have been cancelled in the dao method (#407)
